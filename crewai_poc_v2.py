...
def poc_crew(filename):
    ...
    requirements_task = Task(
        description=(f"""\
            ...
            Determine which data management knowledge area is related to or demanded by each functional and non-functional data management requirement.
        ...
        expected_output="""
            The functional and non-functional requirements extracted from the questionnaire that need to be addressed by specialized agents. 

            The list of requirements or questionnaire responses that could not be addressed by the currently available specialized agents.
            """,
        agent=TaskAgent,
        tools=[file_read_tool()],
    )
    ...
    # Output formatting task with language model configuration
    output_task = Task(
        description=(f"""\            
            Conevert 'how' questions into 'what' and 'why' questions.

            Convert 'which tools' questions into 'what procedures' or 'what processes' questions.
            """
            ),
        expected_output="""
            1) A list of the detailed functional and non-functional requirements extracted from the questionnaire; 
            ...
            5) The list of data integration specific requirements questions that need to be answerd; 
            6) The list of requirements or questionnaire responses that could not be addressed by any of the currently available specialized agents.
            """,
        agent=TaskAgent,
    ...
    crew = Crew(
        ...
        tasks=[requirements_task, output_task, datagov_task, dataquality_task, datastorage_task, dataintegration_task],
